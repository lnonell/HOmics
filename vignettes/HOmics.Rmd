...
- **z.matrix**: matrix with prior information related to features, with rownames the features and columns the samples. It can be the miRNAs targeting genes specified in the data.matrix.
