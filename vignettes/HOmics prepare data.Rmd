...
## Analyzing a Methyation GenomicRatioSet

The package is prepared to analyze GenomicRatioSet (minfi) of methylated data in its default parameters related to relative position of CpGs in a gene.
